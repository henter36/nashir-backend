...
|---|---|
| `docs/nashir_backend_slice_0_permission_guard_primitive_review_gate.md` (PR #29, merge `adca148`) | The authorization source for this gate — Sections 9, 11, and 12 define exactly what this plan may and may not propose; re-read in full and carried forward in Sections 9 and 11 below |
