...
| `occurredAt` | Timestamp when the event occurred; generated by the backend or database, not trusted from client input |
| `metadata` | Additional structured event data |

For V1 planning, `occurredAt` should be generated by the backend or database. It should not be accepted from client request bodies.
